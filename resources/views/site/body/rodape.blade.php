        ...
        <div class="row row-15 flex-md-row-reverse justify-content-md-between align-items-md-center">
          <div class="col-md-6 text-md-right">
            <div class="group-sm group-middle">
              <p class="font-italic text-white">Siga - nós:</p>
          ...
          <div class="col-md-6 text-md-left">
            <p class="rights text-white"><span class="copyright-year"></span><span>&nbsp;&#169;&nbsp;</span><span>PlataformaPL.&nbsp; Todos os direitos reservados.</span>Design&nbsp;Por&nbsp;<a href="https://pissinetsites.com.br/">Pissinat</a></p>
          </div>
        </div>
      </div>
    </div>
